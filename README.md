...
美股和加密货币看似属于两个世界，背后却有一条共同主线：美元。美元仍是全球占主导地位的储备、贸易计价和国际融资货币，美国资本市场则拥有突出的市场深度、流动性和信息披露体系。学习美股，可以帮助初学者理解全球公司如何融资、创造现金流，以及利率、通胀和美元如何影响资产价格。

选择美股并不代表美元永远强势，也不代表美国股票一定上涨。汇率、估值、经济周期、政策和公司经营都可能造成损失。它的学习价值，在于用一个成熟且资料丰富的市场建立股票、ETF、财报和资产配置的基础框架。

加密货币市场则把美元计价的价值进一步带到链上。[USDT、USDC](content/crypto/usdt-usdc-dai.md) 等美元稳定币可以在许多公开区块链和交易平台上全天候流转，让用户在传统银行营业时间之外进行转账、交易和链上结算。从使用体验看，它们提供了一种更开放、流转效率更高的美元数字载体，也是连接传统金融与加密市场的重要入口。

但 USDT 和 USDC 不是“最自由的法币”，也不是美元现金本身；它们是由发行方管理、以美元为锚的[稳定币](content/crypto/stablecoin.md)。持有人仍需承担储备、赎回、监管、地址冻结、智能合约和[脱锚](content/crypto/stablecoin-depeg.md)风险。理解这些边界，比只看到转账便利和高收益更加重要。

把两类市场放在一起学习，可以同时理解美元体系中的传统资产与链上资产：一边是公司所有权、现金流和证券市场，另一边是数字资产、稳定币、智能合约和开放网络。这也是本指南同时覆盖美股与加密货币的原因。
